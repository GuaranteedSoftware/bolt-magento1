    ...
    public function saveAction()
    {
        try {
            ...
            if ($order->isObjectNew()) {
                ...
                $checkoutSession->setData('checkout_type',$checkoutType);
                $sessionQuoteId = ($checkoutType == Bolt_Boltpay_Block_Checkout_Boltpay::CHECKOUT_TYPE_PRODUCT_PAGE) ? null : $checkoutSession->getQuoteId();
